...
console.log(chalk.cyan.bold('║') + chalk.cyan.bold('                    © AAN SILENCE                         ') + '║');
console.log(chalk.cyan.bold('╚══════════════════════════════════════════════════════════════╝\n'));

console.log(chalk.bold('🔰 A A N - S I L E N C E  V 3 . 0 . 0 B A I L S  🔰') + '\n');
...
console.log(chalk.bold('│') + chalk.green.bold('              👑 Owner: Aan'));
